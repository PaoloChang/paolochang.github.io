...
!(function () {
  ...
  const E = 'data-src',
    j = 'data-lqip',
    M = { SHIMMER: 'shimmer', BLUR: 'blur' };
  function S(t) {
    $(this).parent().removeClass(t);
  }
  function A() {
    this.complete &&
      (this.hasAttribute(j) ? S.call(this, M.BLUR) : S.call(this, M.SHIMMER));
  }
  function F() {
    const t = $(this),
      e = t.attr(E);
  ...
  class R {
    ...
    static getTimestamp(t) {
      return Number(t.attr(R.attrTimestamp));
    }
    static getDateFormat(t) {
      return t.attr(R.attrDateFormat);
    }
  }
  !(function () {
    const t = $(window),
    ...
    dayjs.locale(R.locale),
    dayjs.extend(window.dayjs_plugin_localizedFormat),
    $('['.concat(R.attrTimestamp, ']')).each(function () {
      const t = dayjs.unix(R.getTimestamp($(this))),
        e = t.format(R.getDateFormat($(this)));
      $(this).text(e),
        $(this).removeAttr(R.attrTimestamp),
        $(this).removeAttr(R.attrDateFormat);
    ...
    (function () {
      const t = $('article img');
      t.length && t.on('load', A),
        $('article img[loading="lazy"]').each(function () {
          this.complete && S.call(this, M.SHIMMER);
        });
