...
!(function () {
  ...
  class w {
    static on() {
      (w.offset = window.scrollY), b.scrollTop(0);
    }
    static off() {
  ...
  class T {
    static on() {
      l.addClass(v), d.addClass(v), i.addClass(v), u.addClass(y), n.addClass(h);
    }
    static off() {
      n.removeClass(h),
        u.removeClass(y),
  ...
  class k {
    static on() {
      w.resultVisible ||
        (w.on(), f.removeClass(v), c.addClass(v), (w.resultVisible = !0));
    }
    static off() {
      w.resultVisible &&
        (m.empty(),
